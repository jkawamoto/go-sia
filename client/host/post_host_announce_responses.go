...
/* PostHostAnnounceNoContent describes a response with status code 204, with default header values.
...
/* PostHostAnnounceDefault describes a response with status code -1, with default header values.
