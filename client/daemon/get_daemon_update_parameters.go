...
func (o *GetDaemonUpdateParams) WithTimeout(timeout time.Duration) *GetDaemonUpdateParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get daemon update params
func (o *GetDaemonUpdateParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get daemon update params
func (o *GetDaemonUpdateParams) WithContext(ctx context.Context) *GetDaemonUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get daemon update params
func (o *GetDaemonUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get daemon update params
func (o *GetDaemonUpdateParams) WithHTTPClient(client *http.Client) *GetDaemonUpdateParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get daemon update params
func (o *GetDaemonUpdateParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WriteToRequest writes these params to a swagger request
func (o *GetDaemonUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
