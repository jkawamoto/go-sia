...
// NewGetConsensusParams creates a new GetConsensusParams object,
...
// NewGetConsensusParamsWithTimeout creates a new GetConsensusParams object
...
// NewGetConsensusParamsWithContext creates a new GetConsensusParams object
...
// NewGetConsensusParamsWithHTTPClient creates a new GetConsensusParams object
...
/* GetConsensusParams contains all the parameters to send to the API endpoint
   for the get consensus operation.

   Typically these are written to a http.Request.
*/
type GetConsensusParams struct {
