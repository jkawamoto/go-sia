...
// NewPostMinerHeaderParams creates a new PostMinerHeaderParams object
// with the default values initialized.
func NewPostMinerHeaderParams() *PostMinerHeaderParams {

	return &PostMinerHeaderParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMinerHeaderParamsWithTimeout creates a new PostMinerHeaderParams object
...
// NewPostMinerHeaderParamsWithContext creates a new PostMinerHeaderParams object
...
// NewPostMinerHeaderParamsWithHTTPClient creates a new PostMinerHeaderParams object
...
for the post miner header operation typically these are written to a http.Request
*/
...
func (o *PostMinerHeaderParams) WithContext(ctx context.Context) *PostMinerHeaderParams {
	o.SetContext(ctx)
	return o
}
