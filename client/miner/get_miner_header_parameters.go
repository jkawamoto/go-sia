...
// NewGetMinerHeaderParams creates a new GetMinerHeaderParams object
// with the default values initialized.
func NewGetMinerHeaderParams() *GetMinerHeaderParams {

	return &GetMinerHeaderParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMinerHeaderParamsWithTimeout creates a new GetMinerHeaderParams object
...
// NewGetMinerHeaderParamsWithContext creates a new GetMinerHeaderParams object
...
// NewGetMinerHeaderParamsWithHTTPClient creates a new GetMinerHeaderParams object
...
for the get miner header operation typically these are written to a http.Request
*/
...
func (o *GetMinerHeaderParams) WithContext(ctx context.Context) *GetMinerHeaderParams {
	o.SetContext(ctx)
	return o
}
