...
// NewGetHostdbHostsPubkeyParams creates a new GetHostdbHostsPubkeyParams object
// with the default values initialized.
func NewGetHostdbHostsPubkeyParams() *GetHostdbHostsPubkeyParams {
	var ()
	return &GetHostdbHostsPubkeyParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetHostdbHostsPubkeyParamsWithTimeout creates a new GetHostdbHostsPubkeyParams object
...
// NewGetHostdbHostsPubkeyParamsWithContext creates a new GetHostdbHostsPubkeyParams object
...
// NewGetHostdbHostsPubkeyParamsWithHTTPClient creates a new GetHostdbHostsPubkeyParams object
...
for the get hostdb hosts pubkey operation typically these are written to a http.Request
*/
...
func (o *GetHostdbHostsPubkeyParams) WithTimeout(timeout time.Duration) *GetHostdbHostsPubkeyParams {
...
func (o *GetHostdbHostsPubkeyParams) WithContext(ctx context.Context) *GetHostdbHostsPubkeyParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetHostdbHostsPubkeyParams) WithHTTPClient(client *http.Client) *GetHostdbHostsPubkeyParams {
...
func (o *GetHostdbHostsPubkeyParams) WithPubkey(pubkey string) *GetHostdbHostsPubkeyParams {
	o.SetPubkey(pubkey)
	return o
}
...
func (o *GetHostdbHostsPubkeyParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
