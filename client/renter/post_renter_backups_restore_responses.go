...
/*PostRenterBackupsRestoreNoContent handles this case with default header values.
...
/*PostRenterBackupsRestoreDefault handles this case with default header values.
