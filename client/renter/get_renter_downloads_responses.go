...
func (o *GetRenterDownloadsOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateDownloads(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *GetRenterDownloadsOKBody) contextValidateDownloads(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(o.Downloads); i++ {

		if o.Downloads[i] != nil {
			if err := o.Downloads[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("getRenterDownloadsOK" + "." + "downloads" + "." + strconv.Itoa(i))
				}
				return err
...
/*GetRenterDownloadsOKBodyDownloadsItems0 get renter downloads o k body downloads items0
swagger:model GetRenterDownloadsOKBodyDownloadsItems0
*/
...
func (o *GetRenterDownloadsOKBodyDownloadsItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get renter downloads o k body downloads items0 based on context it is used
func (o *GetRenterDownloadsOKBodyDownloadsItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (o *GetRenterDownloadsOKBodyDownloadsItems0) UnmarshalBinary(b []byte) error {
	var res GetRenterDownloadsOKBodyDownloadsItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
